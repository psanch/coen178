...
<head>
	<meta charset="utf-8"/>
      <title>Show Core Courses</title>
   </head>
   <body>

   <!-- Exercise 2: Complete the URLs -->
   <a href='procShowCourseIfCore.php?show=true'>Show Course if it Satisfies a Core Requirement</a>
   <br><br>
...
$conn=oci_connect( 'psanchez','a47k7S4QOi', '//dbserver.engr.scu.edu/db11g' );
	...
	$query = oci_parse($conn, "SELECT * FROM CoreCourse where C1 in ('CTW1','CTW2','CTW3','CNI1','CNI2','CNI3','STS','CivicEngagement','Diversity','Ethics','RTC1','RTC2','RTC3','ELSJ','AdvancedWriting','Arts','Language','NaturalScience','SocialScience','Mathematics')");
